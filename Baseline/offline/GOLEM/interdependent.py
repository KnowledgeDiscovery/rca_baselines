...
if __name__ == '__main__':
    ...
    node_file = './1203/output/'+args.input + '_node_all.npy'
    pod_file = './1203/output/'+args.input + '_pod_all.npy'
    mp_file = '/nfs/users/zach/aiops_data/data/1203/p2n.npy'
    ...
    results_combine.to_csv('./1203/output/'+ args.input + '_hierarchical_ranking_metrics.csv')
