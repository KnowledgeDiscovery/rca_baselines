...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='LSTM algorithm')
    ...
    for metric in metric_names:
        ...
        #LSTM based method
        cg = generate_causal_graph(X, method='lstm', args={'hidden': 50, 'context': 20, 'lam': 10., 'lam_ridge': 1e-2, 'lr': 1e-3, 'max_iter': 1000, 'check_every': 100, 'device': torch.device('cuda')})
