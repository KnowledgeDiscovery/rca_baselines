...
if __name__ == '__main__':
    ...
    node_file = './output/'+args.input + '_node_all.npy'
    pod_file = './output/'+args.input + '_pod_all.npy'
    ...
    results_combine.to_csv('./output/'+ args.input + '_hierarchical_ranking_metrics.csv')
