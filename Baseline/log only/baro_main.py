...
def main(args):
    ...
    POD_METRIC_FILE = {'log_golden_signal': 1, 'log_frequency': 1}
    if data_name in ['20220606', '20210517', '20210524', '20211203', '20231207', '20240124', '20240115', '20231221']:
        log_label = 'ratings.book-info.svc.cluster.local:9080/*'
    elif data_name in ['20231207', '20240215']:
        log_label = 'book_info'
    else:
        raise ValueError('Invalid data_name')
    model_name = 'baro'
